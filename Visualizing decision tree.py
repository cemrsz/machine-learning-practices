...
plt.scatter(elect_train[y_train==1]["minority"],elect_train[y_train==1]["bachelor"] ,marker=".",color="blue",label="Trump", s=50, alpha=0.4)
plt.scatter(elect_train[y_train==0]["minority"],elect_train[y_train==0]["bachelor"],marker=".",color="green",label="Clinton", s=50, alpha=0.4)
